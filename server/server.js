  ...
  (async () => {
    try {
      ...
      const inputProps = {
        ...
        topGradientHeight: topGradientHeight !== undefined ? Number(topGradientHeight) : 0,
        bottomGradientHeight: bottomGradientHeight !== undefined ? Number(bottomGradientHeight) : 650,
        gradientColor,
